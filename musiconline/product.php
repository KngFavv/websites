	...
	<section class="show-products">
		<div class="box-container">
			...
			<div class="box">
				...
				<a href="product.php?edit=<?php echo $fetch_products['id']; ?>" class="edit">edit</a>
				<a href="product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete" onclick="return confirm('want to delete this product');">delete</a>
			</div>
			<?php 
					}
				}else{
